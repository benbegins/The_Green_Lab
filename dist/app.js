...
swiper__WEBPACK_IMPORTED_MODULE_2__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_2__.Navigation]); // Menu
    ...
    menu: function menu() {
      ...
      window.addEventListener("scroll", function (e) {
        if (window.scrollY > 150) {
          _this.burgerDesktop = true;
        } else {
          _this.burgerDesktop = false;
    ...
    cursor: function cursor() {
      ...
      links.forEach(function (link) {
        link.addEventListener("mouseenter", function () {
          _this2.cursorLink = true;
        });
        link.addEventListener("mouseleave", function () {
          _this2.cursorLink = false;
        });
      }); // Over Drag zones

      var dragZones = document.querySelectorAll(".drag");
      dragZones.forEach(function (zone) {
        zone.addEventListener("mouseenter", function () {
          _this2.cursorDrag = true;
        });
        zone.addEventListener("mouseleave", function () {
          _this2.cursorDrag = false;
        });
      });
    },
    animIntro: function animIntro() {
      ...
      tl.fromTo(".title-line-container span", {
        yPercent: 100,
        opacity: 0
      }, {
        yPercent: 0,
      ...
      tl.to(".site-header, .homepage__hero__description, .homepage__hero__social, .homepage__hero__arrow", {
        opacity: 1,
        duration: 0.5,
        ease: "linear"
      }, "-=0.5");
    },
    animScroll: function animScroll() {
      // Reveal
      ...
      if (window.innerWidth >= 1024) {
        var verticalParallaxElements = document.querySelectorAll("[data-parallax-v]");

        if (verticalParallaxElements) {
          verticalParallaxElements.forEach(function (element) {
            gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(element, {
              yPercent: "".concat(element.dataset.parallaxV * 50)
            }, {
              yPercent: "-".concat(element.dataset.parallaxV * 50),
              ease: "none",
              scrollTrigger: {
        ...
        var horizontalParallaxElements = document.querySelectorAll("[data-parallax-h]");

        if (horizontalParallaxElements) {
          horizontalParallaxElements.forEach(function (element) {
            gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(element, {
              xPercent: "".concat(element.dataset.parallaxH * 5)
            }, {
              xPercent: "-".concat(element.dataset.parallaxH * 5),
              ease: "none",
              scrollTrigger: {
...
Vue.createApp(App).mount("#page"); // Products slider
...
if (slider) {
  var arrowsPosition = function arrowsPosition() {
    var height = document.querySelector(".homepage__produits__img-container").offsetHeight;
    btnsArrow.forEach(function (btn) {
      btn.style.top = "".concat(height / 2, "px");
    });
  };
  ...
  var btnsArrow = document.querySelectorAll(".btn-arrow");
