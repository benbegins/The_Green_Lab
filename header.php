...
<div id="page" class="site">
    ...
    <header class="site-header container" id="header">
        ...
        <div class="site-header__logo">
            <a href="<?= get_site_url() ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128.555 48.379">
        ...
        <div class="site-header__menu">
            <!-- Burger -->
            <div class="site-header__burger" @mouseEnter="menuActive = true, cursorLink = true" @mouseLeave="cursorLink = false" @click="menuActive = !menuActive" :class="{active: menuActive, visible: burgerDesktop}">
